...
{
$sql=mysql_query("SELECT password FROM  admin where password='".($_POST['cpass'])."' && username='".$_SESSION['alogin']."'");
$num=mysql_fetch_array($sql);
if($num>0)
{
 $con=mysql_query("update admin set password='".($_POST['newpass'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
